...
pin_labels:
- {pin_num: K1, pin_signal: GPIO_EMC_B1_40, label: RESERVED, identifier: RESERVED}
- {pin_num: R1, pin_signal: GPIO_EMC_B2_03, label: DISP_BL, identifier: SEMC_D19;DISP_BL}
- {pin_num: K2, pin_signal: GPIO_EMC_B2_00, label: LPI2C2_SCL, identifier: LPI2C2_SCL;I2C2_SCL}
- {pin_num: M2, pin_signal: GPIO_EMC_B2_12, label: CAMERA_RST/DISP_RST, identifier: CAMERA_RST;SEMC_D27;DISP_RST}
- {pin_num: N3, pin_signal: GPIO_EMC_B2_18, label: USER_GREEN, identifier: USER_GREEN}
- {pin_num: K4, pin_signal: GPIO_EMC_B2_01, label: LPI2C2_SDA, identifier: LPI2C2_SDA;I2C2_SDA}
- {pin_num: D9, pin_signal: GPIO_DISP_B2_10, label: LPI2C3_SCL, identifier: LPI2C3_SCL}
- {pin_num: A6, pin_signal: GPIO_DISP_B2_11, label: LPI2C3_SDA, identifier: LPI2C3_SDA}
...
- {pin_num: R16, pin_signal: GPIO_AD_09, label: CAMERA_PWDN/CAMERA_RST, identifier: CAMERA_PWDN;CAMERA_RST}
...
- pin_list:
  ...
  - {pin_num: R16, peripheral: GPIO9, signal: 'gpio_io, 08', pin_signal: GPIO_AD_09, identifier: CAMERA_PWDN, direction: OUTPUT}
...
void BOARD_InitMipiCameraPins(void) {
  ...
  /* GPIO configuration of RESERVED on GPIO_EMC_B1_40 (pin K1) */
  gpio_pin_config_t RESERVED_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on GPIO_EMC_B1_40 (pin K1) */
  GPIO_PinInit(GPIO8, 8U, &RESERVED_config);

  /* GPIO configuration of CAMERA_PWDN on GPIO_AD_09 (pin R16) */
  ...
  GPIO_PinInit(GPIO9, 8U, &CAMERA_PWDN_config);
