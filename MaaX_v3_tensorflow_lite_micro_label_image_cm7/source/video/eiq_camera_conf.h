...
#define DEMO_CAMERA_OV5640  4  // MaaXBoard RT OV5640 Camera
...
#endif
//DEMO_CAMERA DEMO_CAMERA_RM68200
#define DEMO_CAMERA DEMO_CAMERA_OV5640   // MaaXBoard RT OV5640 Camera overrides the previous #define
