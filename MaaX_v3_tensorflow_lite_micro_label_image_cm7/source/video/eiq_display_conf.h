...
#define DEMO_PANEL_PH720128T003 3  // MaaXBoard 7 inch display (PowerTip PH720128T003-ZBC02)
#define DEMO_PANEL_AES_ACC_MAAX_DISP2 4
...
#else
#define DEMO_PANEL DEMO_PANEL_PH720128T003
#endif
